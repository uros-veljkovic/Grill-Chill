...
public class FGlavnaForma extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jmiIzmeniRacun.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jmiIzmeniRacunActionPerformed(evt);
            }
        });
        jmenuRacun.add(jmiIzmeniRacun);

        jmiStoranirajRacun.setText("Storniraj");
        jmiStoranirajRacun.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jmiStoranirajRacunActionPerformed(evt);
            }
        });
    ...
    private void jmiStoranirajRacunActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jmiStoranirajRacunActionPerformed
        FRacunPretraga formPretragaRacuna = new FRacunPretraga(this, true, ModeForm.FORM_STORNIRAJ);
        formPretragaRacuna.setVisible(true);
    }//GEN-LAST:event_jmiStoranirajRacunActionPerformed

    private void jmiIzmeniRacunActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jmiIzmeniRacunActionPerformed
        FRacunPretraga formPretragaRacuna = new FRacunPretraga(this, true, ModeForm.FORM_IZMENI);
        formPretragaRacuna.setVisible(true);
    }//GEN-LAST:event_jmiIzmeniRacunActionPerformed
